...
impl TestClient for Client<Backend, Executor, runtime::Justification> {
	fn new_for_tests() -> Self {
...
/// client
fn fake_justify(header: &runtime::Header) -> runtime::Justification {
	...
	runtime::Justification(hash, authorities)
}
