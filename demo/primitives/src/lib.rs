...
/// Justification for Blocks on this Network
pub type Justification = generic::Justification<rhd::messages::Justification<Hash>>;
...
pub type SignedBlock = generic::SignedBlock<Block, Justification>;
